...
```bash
btcli subnet register --netuid 315 --subtensor.network test --wallet.name miner --wallet.hotkey default
```
...
```bash
btcli subnet register --netuid 315 --subtensor.network test --wallet.name validator --wallet.hotkey default
```
